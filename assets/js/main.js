...
// ==========================================================================
// PARALLAX (lightweight, rAF-driven)
// ==========================================================================
...
function initParallax() {
  ...
  if (window.innerWidth < 1024) return; // keep effect for larger viewports only
  ...
  function update() {
    const offset = Math.round(window.scrollY * 0.15); // gentle parallax factor
  ...
  // Reset transform when resizing to small screens
  window.addEventListener("resize", () => {
    if (window.innerWidth < 1024) heroBg.style.transform = "";
  });
}
